...
<div className="bg-base-200 p-24 rounded-lg shadow-lg">
          <div className="flex justify-center">
              <div className="w-24 h-24 rounded-full overflow-hidden">
              <img className="w-full h-full object-cover" src={`http://localhost:3000/user/getimage/${props.data.filename}`} alt="User Profile" style={{ filter: 'grayscale(0%) brightness(100%)' }} />
